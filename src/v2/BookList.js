...
import { Container, Content, Card, CardItem, Text, Button, Icon, Left, Body, Right, View, ListItem } from "native-base";
                    ...
                    <ListItem>
                        <View style={{padding: 10, alignContent: 'center'}}>
                            ...
                            <FlatList
                                    ...
                                    renderItem={({item}) => (
                                        <TouchableOpacity onPress={() => this.props.navigation.navigate('BookView', { item })}>
                                            <Card>
                                                <CardItem cardBody>
